...
<head>
    ...
    <style>
        ...
        @media (max-width: 1000px) {
          .container { width: 98vw; padding: 7vw 2vw; }
        }
        .btn-cancel {
...
<div class="container">
    ...
    <h:form>
        <div class="search-panel">
            ...
            <h:inputText value="#{paymentController.providerId}" styleClass="search-input" />
            <h:commandButton value="Search" styleClass="search-btn" action="#{paymentController.searchByProvider}" />
        </div>
        ...
        <h:panelGroup rendered="#{not empty paymentController.paginatedClaimsList}">
            <div class="table-wrap">
            <h:dataTable value="#{paymentController.paginatedClaimsList}" var="row" styleClass="payment-table">
...
<h:column>
    <f:facet name="header">
        <h:panelGroup layout="block" style="display: flex; justify-content: center; align-items: center;">
            <h:outputText value="Claim ID" style="color: white; margin-right: 5px;" />
            <h:panelGroup layout="block" style="display: flex; flex-direction: column;">
               <h:commandLink value="▲" action="#{paymentController.sortBy('claimId')}"
...
<h:column>
    <f:facet name="header">
        <h:panelGroup layout="block" style="display: flex; justify-content: center; align-items: center;">
            <h:outputText value="Provider ID" style="color: white; margin-right: 5px;" />
            <h:panelGroup layout="block" style="display: flex; flex-direction: column;">
                <h:commandLink value="▲" action="#{paymentController.sortBy('providerId')}"
...
<h:column>
    <f:facet name="header">
        <h:panelGroup layout="block" style="display: flex; justify-content: center; align-items: center;">
            <h:outputText value="Recipient ID" style="color: white; margin-right: 5px;" />
            <h:panelGroup layout="block" style="display: flex; flex-direction: column;">
                <h:commandLink value="▲" action="#{paymentController.sortBy('recipientId')}"
...
<h:column>
    <f:facet name="header">
        <h:panelGroup layout="block" style="display: flex; justify-content: center; align-items: center;">
            <h:outputText value="Amount Claimed" style="color: white; margin-right: 5px;" />
            <h:panelGroup layout="block" style="display: flex; flex-direction: column;">
                <h:commandLink value="▲" action="#{paymentController.sortBy('amountClaimed')}"
    ...
    <h:outputText value="#{row.claim.amountClaimed}" />
                ...
                <h:column>
                    ...
                    <h:selectOneMenu value="#{row.paymentMethod}" styleClass="method-select">
                ...
                <h:column>
                    ...
                    <h:inputTextarea value="#{row.remarks}" rows="2" cols="23" styleClass="remark-box" />
                </h:column>
            </h:dataTable>
            </div>
            ...
            <h:outputText value="Showing #{paymentController.showingFrom}-#{paymentController.showingTo} out of #{paymentController.totalRecords}" styleClass="total-info" />
            <div class="pages">
	            <h:commandButton value="Previous"
                    action="#{paymentController.previousPage}"
                    disabled="#{paymentController.previousDisabled}" styleClass="pagination-btn" />
	            ...
	            <h:commandButton value="Next" 
                    ...
                    disabled="#{paymentController.nextDisabled}" styleClass="pagination-btn" />
        	</div>
            ...
            <div class="process-btn-section" style="margin-top: 24px;">
                <h:commandButton 
                    value="Process All Selected Payments"
