...
<f:view>
    ...
    <div class="container">
        ...
        <div class="grid-panel">
            ...
            <h:form>
                <h:commandButton value="🔎 Search & Process Claims" action="searchClaims.jsf?faces-redirect=true" styleClass="admin-btn cyan-btn" />
            </h:form>

            <h:form>
                <h:commandButton value="💰 Pay Hospitals" action="processPayments.jsf?faces-redirect=true" styleClass="admin-btn fuchsia-btn" />
            </h:form>
        </div>
    </div>
