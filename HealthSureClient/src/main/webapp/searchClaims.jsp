    ...
    $(function () {
        setTimeout(function () {
            ...
            $("input[id$='fromDate']").datepicker({
                ...
                changeYear: true,
                yearRange: "1990:2050",
                maxDate: today // ✅ Restrict to today
            });
	...
	<h:form styleClass="glass-card" prependId="true">
		...
		<div class="search-form-container">
			<div class="form-group">
				<h:outputLabel for="searchType" value="Search By" styleClass="search-label"/>
			...
			<h:panelGroup layout="block" styleClass="search-extra-panel"
				...
				<div class="form-group">
					<h:outputLabel for="statusField" value="Claim Status:" styleClass="search-label"/>
			...
			<h:panelGrid styleClass="search-panel" rendered="#{claimController.searchType eq 'subscribeId'}">
				<div class="form-group">
			...
			<h:panelGrid styleClass="search-panel" rendered="#{claimController.searchType eq 'providerId'}">
			<div class="form-group">
			...
			<h:panelGrid  styleClass="search-panel" rendered="#{claimController.searchType eq 'hId'}" >
			<div class="form-group">
			...
			<h:panelGrid  styleClass="search-panel" rendered="#{claimController.searchType eq 'dateRange'}" >
			<div class="form-group">
		...
		<div class="search-btn-row">
            ...
            <h:commandButton value="RESET" action="#{claimController.resetButton}" styleClass="big-search-btn" />
		</div>
		</h:form>
	<h:form>
...
<div class="container">
    ...
    <div class="search-panel">
        ...
        <h:panelGroup rendered="#{not empty claimController.subscribe.subscribeId}">
            <span class="panel-separator"> | </span>Subscribe ID: <h:outputText value="#{claimController.subscribe.subscribeId}" />
        </h:panelGroup>
        <h:panelGroup rendered="#{not empty claimController.recipient.hId}">
            <span class="panel-separator"> | </span>HID: <h:outputText value="#{claimController.recipient.hId}" />
        </h:panelGroup>
        <h:panelGroup rendered="#{claimController.claim.claimStatus != null}">
            <span class="panel-separator"> | </span>Status: <h:outputText value="#{claimController.claim.claimStatus}" />
        </h:panelGroup>
    </div>
        ...
        <div class="pagination-controls">
            ...
            <div class="pages">
	            ...
	            <h:commandButton value="Next" action="#{claimController.nextPage}" disabled="#{claimController.nextDisabled}" styleClass="pagination-btn" />
        	</div>
